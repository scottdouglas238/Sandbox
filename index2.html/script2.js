                            ...
                            $.ajax({
                                ...
                                .then(function (response3) {
                                    ...
                                    $("#fiveDayForecast").attr("style", "display: none");
                                        ...
                                        var buttonCityInput = localStorage.getItem("city", cityArray);
                                        var weWilSee = JSON.parse(buttonCityInput)
                                        // console.log(weWilSee);
                                            // console.log(weWilSee)
                                        
                                    for (let i = 0; i < weWilSee.length; i++) {
                                        var weWilSee2 = weWilSee[i];
                                        console.log(weWilSee2);
                                    if(weWilSee2.includes(cityNameInput)){    
                                            
                                        
    
                                       
    
                                        let cityQueryURL = "https://api.openweathermap.org/data/2.5/weather?q=" + weWilSee2 + "&appid=81b8efee373b3e6d158e294464dbc522";
                                        ...
                                        //above ^ this is where the if than statement curley bracket will go    
                                        };
                                      //
                                    });
